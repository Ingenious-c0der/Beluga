...
enum class ERROR_TYPES
{
    ...
    MISSING_COMPONENT = -258,
    UNKNOWN_TOKEN_FOUND = -259,
    INVALID_IMPORT_STATEMENT = -260,
};
...
constexpr const char* stringify(ERROR_TYPES e)
{
    ...
    case ERROR_TYPES::INVALID_MACHINE_DEFINITION: return "INVALID_MACHINE_DEFINITION";
    case ERROR_TYPES::INVALID_TRANSITION_DEFINITION: return "INVALID_TRANSITION_DEFINITION";
    case ERROR_TYPES::MISSING_COMPONENT: return "MISSING_COMPONENT";
    case ERROR_TYPES::UNKNOWN_TOKEN_FOUND: return "UNKNOWN_TOKEN_FOUND";
